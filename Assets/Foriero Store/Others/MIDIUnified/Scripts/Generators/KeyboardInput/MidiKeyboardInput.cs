...
public class MidiKeyboardInput : MonoBehaviour, IMidiSender
{
    ...
    private MidiKeyboardInputBinding.KeyBindings ABCDEFGBindings = new MidiKeyboardInputBinding.KeyBindings()
    {
        ...
        {
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.A, toneEnum = ToneEnum.A, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.B, toneEnum = ToneEnum.B, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.C, toneEnum = ToneEnum.C, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.D, toneEnum = ToneEnum.D, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.E, toneEnum = ToneEnum.E, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.F, toneEnum = ToneEnum.F, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.G, toneEnum = ToneEnum.G, octaveShift = 0 },
        }
    };
    ...
    private MidiKeyboardInputBinding.KeyBindings QUERTYBindings = new MidiKeyboardInputBinding.KeyBindings()
    {
        keyBindings = new MidiKeyboardInputBinding.KeyBinding[]
        {
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.A, toneEnum = ToneEnum.C, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.W, toneEnum = ToneEnum.CSharpDFlat, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.S, toneEnum = ToneEnum.D, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.E, toneEnum = ToneEnum.DSharpEFlat, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.D, toneEnum = ToneEnum.E, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.F, toneEnum = ToneEnum.F, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.T, toneEnum = ToneEnum.FSharpGFlat, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.G, toneEnum = ToneEnum.G, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.Y, toneEnum = ToneEnum.GSharpAFlat, octaveShift = 0 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.H, toneEnum = ToneEnum.A, octaveShift = 1 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.U, toneEnum = ToneEnum.ASharpBFlat, octaveShift = 1 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.J, toneEnum = ToneEnum.B, octaveShift = 1 },
            new MidiKeyboardInputBinding.KeyBinding() { keyCode = KeyCode.K, toneEnum = ToneEnum.C, octaveShift = 1 },
        }
    };
    ...
    private void ProceedKeyboardInput()
    {
        ...
        if (keyBindings != null)
        {
            for (int i = 0; i < keyBindings.keyBindings.Length; i++)
            {
