        ...
        public static class MidiStringParser
        {
            ...
            static void ParseNoteON()
            {
                ...
                if (items.Length == 5)
                {
                    ...
                    {
                       MidiOut.NoteDispatch(tones[i], aDelay: starts[i], aVolume: (volumes[i] * masterVolume).ToByteVolume());
                    }
                }
                else if (items.Length == 6)
                {
                    ...
                    for (int i = 0; i < tones.Length; i++)
                    {
                        MidiOut.NoteDispatch(tones[i], aDuration: durations[i], aDelay: starts[i], aVolume: (volumes[i] * masterVolume).ToByteVolume());
                    }
                }
                else
                {
