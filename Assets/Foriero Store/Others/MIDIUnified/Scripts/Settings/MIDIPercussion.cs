...
namespace ForieroEngine.MIDIUnified
{
    public partial class MIDIPercussion : MonoBehaviour
    {
        ...
        public static MIDIPercussionSettings settings => MIDIPercussionSettings.instance;
        ...
        private List<ScheduledPercussion> _scheduledPercussionItems = new List<ScheduledPercussion>();
        private List<AudioObject> _playingPercussionItems = new List<AudioObject>();
        private List<AudioObject> _percussionItems = new List<AudioObject>();
