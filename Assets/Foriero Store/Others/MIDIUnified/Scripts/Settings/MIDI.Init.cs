...
namespace ForieroEngine.MIDIUnified
{
    public partial class MIDI : MonoBehaviour
    {
        ...
        static bool soundFontCopiedToPersistentPath = false;
        public static TextAsset soundFontAsset = null;

        static IEnumerator InitSoundFontRousources()
        {
        ...
        static IEnumerator InitSoundFontPersistentPath()
        {
            if (File.Exists(MIDISettings.soundFontPersistentPath)) yield break;

            yield return InitSoundFontRousources();
        ...
        static IEnumerator InitSoundFont()
        {
            ...
            switch (MIDISynthSettings.GetPlatformSettings().GetSynthEnum())
            {
                ...
                case Synth.SynthEnum.CSHARP: yield return InitSoundFontRousources(); break;
#if MIDIUNIFIED_BETA
