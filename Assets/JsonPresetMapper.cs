...
public class JsonPresetMapper : MonoBehaviour
{
    ...
    public void WritePresetToPersistentDataPath()
    {
        HelmPatchFormat patch = CreatePatch();
        // Get the path to the persistent data directory on Android
        string directoryPath = Path.Combine(Application.persistentDataPath, "Custom");
